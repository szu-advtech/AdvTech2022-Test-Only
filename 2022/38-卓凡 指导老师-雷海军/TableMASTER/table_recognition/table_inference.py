...
if __name__ == '__main__':
    ...
    cfg = {
        ...
        'pse_ckpt': './work_dir/1210_PseNet_textdet/epoch_600.pth',
        'master_ckpt': './work_dir/1123_MASTER_textline/epoch_10.pth',
        'structure_master_ckpt': './work_dir/1114_TableMASTER_structure/epoch_17.pth',
        # 'end2end_result_folder': '/data_0/work_dirs/end2end_val_result',
        'end2end_result_folder': './data/end2end_val_result',
        # 'structure_master_result_folder': '/data_0/work_dirs/structure_val_result',
        'structure_master_result_folder': './data/structure_val_result',


        # 'test_folder': '/data_0/dataset/pubtabnet/val/',
        'test_folder': './data/pubtabnet/val/',
