...
def parse_tablemaster_args():
    ...
    parser.add_argument('--lmdb-root', type=str, default='/root/zf/TableMASTER-mmocr/data/lmdb/',
                        help='lmdb output path.')
    ...
    parser.add_argument('--txt-folder', type=str, default='/root/zf/TableMASTER-mmocr/data/pubtabnet_preprocessed/StructureLabelAddEmptyBbox_train',
                        help='TableMASTER txt folder.')
    # parser.add_argument('--img-root', type=str, default='/data_0/dataset/pubtabnet',
    #                     help='pubtabnet dataset imgs root.')
    parser.add_argument('--img-root', type=str, default='/root/zf/TableMASTER-mmocr/data/pubtabnet',
                        help='pubtabnet dataset imgs root.')
...
def parse_master_args():
    ...
    parser.add_argument('--txt-root', type=str, default='/root/zf/TableMASTER-mmocr/data/pubtabnet_preprocessed',
                        help='MASTER txts root.')
    # parser.add_argument('--img-root', type=str, default='/data_0/dataset/processed_data_0927',
    #                     help='text-line cropped imgs root.')
    parser.add_argument('--img-root', type=str, default='/root/zf/TableMASTER-mmocr/data/pubtabnet_preprocessed',
                        help='text-line cropped imgs root.')
    args = parser.parse_args()
    return args
...
if __name__ == '__main__':
    ...
    # lmdb_path = '/root/zf/TableMASTER-mmocr/data/lmdb/MasterRecLabel_val/'
    # coding = 'utf8'
    # env = lmdb.open(
    #     lmdb_path,
    #     max_readers=1,
