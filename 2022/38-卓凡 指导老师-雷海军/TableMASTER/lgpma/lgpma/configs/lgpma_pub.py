...
data = dict(
    ...
    train=dict(
        ...
        img_prefix='/root/zf/TableMASTER-mmocr/data/pubtabnet'),
    # According to the evaluation metric, select the appropriate validation dataset format.
    val=dict(
        ann_file='/root/zf/DAVAR-Lab-OCR/demo/table_recognition/datalist/PubTabNet_2.0.0_val.jsonl',
        img_prefix='/root/zf/TableMASTER-mmocr/data/pubtabnet'),
    test=dict(
        samples_per_gpu=1,
        ...
        ann_file='/root/zf/DAVAR-Lab-OCR/demo/table_recognition/datalist/PubTabNet_2.0.0_val.jsonl',
        img_prefix='/root/zf/TableMASTER-mmocr/data/pubtabnet/val/')
)
