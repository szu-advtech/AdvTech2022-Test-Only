...
vis_dir = "/root/zf/DAVAR-Lab-OCR/output/images/" # path to save visualization results

# path setting
savepath = "/root/zf/DAVAR-Lab-OCR/output/prediction.json" # path to save prediction
config_file = '/root/zf/DAVAR-Lab-OCR/demo/table_recognition/lgpma/configs/lgpma_pub.py' # config path
checkpoint_file = '/root/zf/DAVAR-Lab-OCR/model/maskrcnn-lgpma-pub-e12-pub.pth' # model path
...
for sample in tqdm(test_file):
    ...
    if do_visualize:
        ...
        # print(result['content_ann']['bboxes'])
        bboxes = []
        for b in result['content_ann']['bboxes']:
            if b != []:
