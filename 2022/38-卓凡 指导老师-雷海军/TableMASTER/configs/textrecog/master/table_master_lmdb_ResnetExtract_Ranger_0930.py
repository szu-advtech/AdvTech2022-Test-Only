...
alphabet_file = '/root/zf/TableMASTER-mmocr/data/structure_alphabet.txt'
...
model = dict(
    ...
    decoder=dict(
        ...
        type='TableMasterDecoderRes',
        N=3,
        # N=4, #add 1 transformer layer 
        decoder=dict(
            self_attn=dict(
                headers=8,
                d_model=512,
...
train_img_prefix = '/root/zf/TableMASTER-mmocr/data/pubtabnet/train/'
train_anno_file1 = '/root/zf/TableMASTER-mmocr/data/lmdb/StructureLabel_train/'
# train_img_prefix = ''
# train_anno_file1 = ''
train1 = dict(
    type=dataset_type,
...
valid_img_prefix = '/root/zf/TableMASTER-mmocr/data/pubtabnet/val/'
valid_anno_file1 = '/root/zf/TableMASTER-mmocr/data/lmdb/StructureLabel_val/'
# valid_img_prefix = ''
# valid_anno_file1 = ''
valid = dict(
    type=dataset_type,
...
test_img_prefix = '/root/zf/TableMASTER-mmocr/data/pubtabnet/val/'
test_anno_file1 = '/root/zf/TableMASTER-mmocr/data/lmdb/StructureLabel_val/'
# test_img_prefix = ''
# test_anno_file1 = ''
test = dict(
    type=dataset_type,
...
load_from = None
# resume_from = None
# resume_from = "/root/zf/TableMASTER-mmocr/work_dir/1114_TableMASTER_structure/latest.pth"
workflow = [('train', 1)]
