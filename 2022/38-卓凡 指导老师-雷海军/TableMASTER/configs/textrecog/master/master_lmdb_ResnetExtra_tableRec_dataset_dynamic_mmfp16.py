...
alphabet_file = '/root/zf/TableMASTER-mmocr/data/textline_recognition_alphabet.txt'
...
train_anno_file1 = '/root/zf/TableMASTER-mmocr/data/lmdb/MasterRecLabel_train/'
train1 = dict(
    type=dataset_type,
...
test_ann_files = {'table_Rec_val': '/root/zf/TableMASTER-mmocr/data/lmdb/MasterRecLabel_val/'}
testset = [dict(
    type=dataset_type,
