...
from .master_decoder import MasterDecoder, TableMasterDecoder, TableMasterConcatDecoder, TableMasterDecoderRes
...
__all__ = [
    ...
    'TableMasterDecoder', 'TableMasterConcatDecoder', 'TableMasterDecoderRes'
]
