...
@SuppressWarnings("all") public class PutResponseMessage implements org.apache.thrift.TBase<PutResponseMessage, PutResponseMessage._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new PutResponseMessageStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PutResponseMessageTupleSchemeFactory());
  }
  ...
  private static class PutResponseMessageStandardSchemeFactory implements SchemeFactory {
    public PutResponseMessageStandardScheme getScheme() {
      return new PutResponseMessageStandardScheme();
    }
  }
  private static class PutResponseMessageStandardScheme extends StandardScheme<PutResponseMessage> {
    public void read(org.apache.thrift.protocol.TProtocol iprot, PutResponseMessage struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PutResponseMessage struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PutResponseMessageTupleSchemeFactory implements SchemeFactory {
    public PutResponseMessageTupleScheme getScheme() {
      return new PutResponseMessageTupleScheme();
    }
  }
  private static class PutResponseMessageTupleScheme extends TupleScheme<PutResponseMessage> {
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PutResponseMessage struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      struct.header.write(oprot);
    }
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PutResponseMessage struct) throws org.apache.thrift.TException {
