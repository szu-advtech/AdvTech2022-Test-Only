...
@SuppressWarnings("all") public class FullSyncRequestMessage implements org.apache.thrift.TBase<FullSyncRequestMessage, FullSyncRequestMessage._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new FullSyncRequestMessageStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FullSyncRequestMessageTupleSchemeFactory());
  }
  ...
  private static class FullSyncRequestMessageStandardSchemeFactory implements SchemeFactory {
    public FullSyncRequestMessageStandardScheme getScheme() {
      return new FullSyncRequestMessageStandardScheme();
    }
  }
  private static class FullSyncRequestMessageStandardScheme extends StandardScheme<FullSyncRequestMessage> {
    public void read(org.apache.thrift.protocol.TProtocol iprot, FullSyncRequestMessage struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FullSyncRequestMessage struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FullSyncRequestMessageTupleSchemeFactory implements SchemeFactory {
    public FullSyncRequestMessageTupleScheme getScheme() {
      return new FullSyncRequestMessageTupleScheme();
    }
  }
  private static class FullSyncRequestMessageTupleScheme extends TupleScheme<FullSyncRequestMessage> {
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FullSyncRequestMessage struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      struct.header.write(oprot);
    }
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FullSyncRequestMessage struct) throws org.apache.thrift.TException {
