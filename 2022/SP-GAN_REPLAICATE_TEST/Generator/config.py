...
data_root_part = root+"\\data\\shapenet"
data_root_h5 = root+"\\data\\shapenet"
...
parser.add_argument('--choice', default='airplane', help='choice class')
...
parser.add_argument('--d_flip', action='store_true',help='use offset')
parser.add_argument('--g_flip', action='store_true',help='use offset')
...
opts = check_args(parser.parse_known_args()[0])
