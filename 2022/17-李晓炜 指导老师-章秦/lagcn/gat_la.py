...
class Args():
    def __init__(self, samples=4, concat=4, runs=100, dataset='cora', seed=42, epochs=10000, lr=0.005, weight_decay=5e-4, hidden=8, nb_heads=8, nb_heads_2=1, dropout=0.6, alpha=0.2, tem=0.5, lam=1.):
